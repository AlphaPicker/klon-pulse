...
const CACHE_NAME = 'klon-pulse-v3'; // <-- À incrémenter à chaque mise à jour (v2, v3, etc.)
...
// 2. Supprime automatiquement l'ancien cache ('klon-pulse=-v1', etc.) dès que la v2 s'active
